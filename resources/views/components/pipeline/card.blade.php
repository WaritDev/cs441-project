...
<div draggable="true" @dragstart="startDrag($event, {{ json_encode($deal) }})" @class([
    'p-4 rounded-xl border-2 shadow-sm bg-white cursor-move hover:shadow-md transition-all relative group',
    'border-red-300 ring-2 ring-red-100' => $deal->isStale(), // Warning Style
    'border-transparent hover:border-emerald-300' => !$deal->isStale()
])>
    <div class="mb-3">
