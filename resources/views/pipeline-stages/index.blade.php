        ...
        <div class="px-6 py-6 border-b border-slate-100 flex items-center justify-between bg-white sticky top-0 z-20">
            <div>
                ...
                <p class="text-slate-500 mt-1">
                    มูลค่ารวม <span
                        class="font-bold text-slate-800">฿{{ number_format(collect($deals)->sum('amount')) }}</span>
                </p>
            </div>
            <button onclick="window.location='{{ route('deals.create') }}'"
                class="bg-slate-900 text-white px-5 py-2.5 rounded-lg hover:bg-slate-800 flex items-center gap-2 shadow-lg shadow-slate-900/20 transition-all">
